...
(function (global, factory) {
  ...
  var SignaturePad = (function () {
      function SignaturePad(canvas, options,onCallback) {
		  ...
		  console.log('signature_pad_init :onCallback :', typeof this.onCallback );
		  console.log('signature_pad_init :onCallback f:', this.onCallback );
